...
do
cdo remapbil,cmip6_Ts_grid05.txt ../Data/cmip6_tsl_interp_depth_198010/"${i}"_*.nc ../Data/cmip6_tsl_05_depth_interpolated/"${i}"_tsl_monthly_0_3_hd.nc
cdo remapbil,cmip6_Ts_grid05.txt ../Data/cmip6_mrsfl/mrsfl_Emon_"${i}"_*.nc ../Data/cmip6_mrsfl/"${i}"_mrsfl_monthly_hd.nc
cdo remapbil,cmip6_Ts_grid05.txt ../Data/cmip6_mrsll/mrsll_Emon_"${i}"_*.nc ../Data/cmip6_mrsll/"${i}"_mrsll_monthly_hd.nc
echo "${i}"
done